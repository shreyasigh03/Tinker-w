...
<table
  ...
  cellpadding="0"
  cellspacing="0"
  style="background:#050508;padding:40px 16px;"
>
...
<table
  ...
  cellpadding="0"
  cellspacing="0"
  style="max-width:480px;background:#101116;border:1px solid rgba(255,255,255,0.08);border-radius:20px;overflow:hidden;"
>
...
<div
  ...
  height:52px;
  border-radius:50%;
  background:radial-gradient(circle at 35% 28%,#EEF1FF,#98A0FA 45%,#5A5FEA 78%,#3E3FC9);
  margin-bottom:24px;
  "
></div>
